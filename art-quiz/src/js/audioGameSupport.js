...
let audioArr = [rightAudio, wrongAudio, victoryAudio];
...
function audioMute() {
  audioArr.forEach(e => {
    ...
    volumeProgress.style.background = `linear-gradient(to right, rgb(137, 178, 212) 0%, rgb(137, 178, 212) ${volumeProgress.value * 100}%, #fff ${volumeProgress.value * 100}%, #fff 100%)`;
  })
};
